	...
	>
		...
		>
					...
					>
						<div class="flex items-center gap-4">
							...
							<div class="flex-1">
								...
								<p class="text-white/60 text-sm mt-1">Create a new identity with a fresh 12-word recovery phrase</p>
							</div>
					...
					>
						<div class="flex items-center gap-4">
							...
							<div class="flex-1">
								...
								<p class="text-white/60 text-sm mt-1">Use your existing 12 or 24-word recovery phrase</p>
							</div>
							<span class="text-white/40 text-2xl">→</span>
						</div>
					</button>
			...
			{:else if mode === 'generate'}
				...
				<div class="bg-gray-800 border border-white/20 rounded-xl p-6 mb-6">
			...
			{:else if mode === 'import'}
				...
				<p class="text-white/60 mb-6">Enter your 12 or 24-word recovery phrase</p>
				{#if error}
				...
				<div class="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4 mb-6">
					<p class="text-blue-400 text-sm">💡 Tip: Paste your seed phrase directly. Words should be separated by spaces.</p>
				</div>
				<div class="flex gap-4">
					<button type="button" onclick={handleBack} class={buttonSecondaryClass}>Back</button>
