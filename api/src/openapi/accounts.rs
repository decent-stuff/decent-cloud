use super::common::{
    AddAccountContactRequest, AddAccountSocialRequest, ApiResponse, ApiTags, decode_hex_path,
    decode_pubkey, RegisterAccountRequest, UpdateAccountEmailRequest, UpdateAccountProfileRequest,
};
...
mod tests {
    ...
    use crate::openapi::common::{
        AddAccountContactRequest, AddAccountSocialRequest, ApiResponse, RegisterAccountRequest,
