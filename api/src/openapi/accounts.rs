use super::common::{
    ...
    AddAccountSocialRequest, ApiResponse, ApiTags, decode_hex_path, decode_pubkey,
    RegisterAccountRequest, UpdateAccountEmailRequest, UpdateAccountProfileRequest,
...
mod tests {
    ...
    use crate::openapi::common::{
        AddAccountContactRequest, AddAccountExternalKeyRequest, AddAccountKeyRequest,
        AddAccountSocialRequest, ApiResponse, RegisterAccountRequest,
        UpdateAccountEmailRequest, UpdateAccountProfileRequest, UpdateDeviceNameRequest,
    };
