use super::common::{
    ...
    ExtendContractResponse, RentalRequestResponse, RotateSshKeyRequest,
...
impl ContractsApi {
    ...
    async fn rotate_ssh_key(
        ...
        if !crate::validation::is_valid_ssh_pubkey_format(&new_key) {
            return Json(ApiResponse {
                success: false,
                data: None,
                error: Some(
    ...
    async fn create_rental_request(
        ...
        match &params.0.ssh_pubkey {
            ...
            Some(key) => {
                ...
                if !crate::validation::is_valid_ssh_pubkey_format(key.trim()) {
                    return Json(ApiResponse {
                        success: false,
                        data: None,
                        error: Some(
...
mod tests {
    ...
    use crate::database::contracts::{Contract, ContractExtension};
    use crate::openapi::common::ApiResponse;
    use crate::openapi::common::{
        CancelContractRequest, ExtendContractRequest, ExtendContractResponse,
        RentalRequestResponse, VerifyCheckoutSessionRequest, VerifyCheckoutSessionResponse,
    };
