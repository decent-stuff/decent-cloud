-- Example Offerings Migration
-- Adds example offerings for each product type to help with CSV template generation
-- Uses a special example provider pubkey for easy identification
...
(
    ...
    1, '25 Gbps', NULL, 'Singapore', 'Singapore', 1.3521, 103.8198,
...
(
    ...
    0, '10 Gbps', 5000, 'Global', 'Multiple POPs', NULL, NULL,
    'REST API', 720, 8760,
...
(
    ...
    2, '2 TB', 2, '480 GB', 0, '1 Gbps', 20000,
...
(
    ...
    NULL, NULL, 4, '8 TB', 1, '10 Gbps', NULL,
