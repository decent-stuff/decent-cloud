        ...
        <div className="mb-6">
          ...
          <div className="bg-blue-900/30 p-4 rounded-lg mb-4">
            ...
            <p className="text-white/90 text-sm">
              This is a demonstration page with mock data. In the future, this
              marketplace will contain real offerings from providers on the
              network.
            </p>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex justify-between mb-4">
                ...
                <span className="text-yellow-400">
                  {"★".repeat(Math.floor(offering.rating))} {offering.rating}
                </span>
              </div>
