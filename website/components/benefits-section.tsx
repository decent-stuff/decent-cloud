    ...
    <section id="benefits" className="py-20">
      <div className="container mx-auto px-6 text-center">
        <HeaderSection
          title={"Benefits"}
          subtitle={
            "Unlock the advantages for developers and providers in the decentralized cloud"
          }
        />
        <motion.div
        ...
        >
          ...
          >
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-3 text-left">
              <li>
                <strong>Convenience and ease of use:</strong> Find suitable
                cloud providers faster than you can say &quot;404 not
                found&quot;.
              </li>
              <li>
                <strong>Trust:</strong> Obtain legal guarantees and SLAs worth
                the digital paper they&apos;re written on.
              </li>
              <li>
                <strong>No vendor lock-in:</strong> Easy multi-cloud deployments
          ...
          >
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-3 text-left">
              <li>
                <strong>Market:</strong> Access to a trillion-dollar crypto
                market.
              </li>
              <li>
                <strong>Users:</strong> Reach a global user base.
              </li>
              <li>
                <strong>Fair pricing:</strong> Transparent pricing without a
          ...
          >
            ...
            >
              ...
              <span className="absolute inset-0 bg-white/20 rounded-full scale-0 transition-transform duration-300 group-hover:scale-100"></span>
            </Button>
          </motion.div>
        </motion.div>
      </div>
