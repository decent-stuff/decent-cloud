        ...
        {dashboardItems
          ...
          .map((item, index) => (
            <div
              ...
              className={`border border-white/10 group relative flex flex-col bg-gradient-to-r from-gray-800/30 to-gray-700/30 rounded-xl p-3 sm:p-4 hover:bg-white/10 hover:shadow-xl transition duration-300 ease-in-out shadow-lg ${
                item.key === "userDctBalance" ? "cursor-pointer" : "cursor-help"
              }`}
            >
