...
<div class="space-y-8">
	...
	{#if !isAuthenticated}
		<AuthRequiredCard subtext="Create an account or login to become a reseller and manage your reseller relationships." />
	{:else}
		{#if error}
								...
								<div class="flex items-center justify-between">
									<div class="flex-1">
										...
										{#if provider.website_url}
											<a href={provider.website_url} target="_blank" rel="noopener noreferrer" class="text-primary-400 hover:text-primary-300 text-sm mt-1 inline-block">
