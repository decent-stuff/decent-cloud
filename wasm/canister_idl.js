export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    data_fetch: IDL.Func([IDL.Opt(IDL.Text), IDL.Opt(IDL.Vec(IDL.Nat8))], [ResultData], ['query']),
    ...
    get_identity_reputation: IDL.Func([IDL.Vec(IDL.Nat8)], [IDL.Nat64], ['query']),
    ...
    icrc3_get_archives: IDL.Func([Icrc3GetArchivesArgs], [Icrc3GetArchivesResult], ['query']),
    icrc3_get_blocks: IDL.Func([IDL.Vec(GetBlocksArgs)], [Icrc3GetBlocksResponse], ['query']),
    ...
    metadata: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Text, MetadataValue))], ['query']),
    ...
    node_provider_register: IDL.Func([IDL.Vec(IDL.Nat8), IDL.Vec(IDL.Nat8)], [ResultString], []),
