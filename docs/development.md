...
docker compose -f cf/docker-compose.dev.yml build api-serve
```

The build arguments are defined in `cf/docker-compose.dev.yml` and default to 1000 if not specified.
